...
'https://josd.github.io/imagining#path'(A, B) :-
    'https://josd.github.io/imagining#oneway'(A, B).
'https://josd.github.io/imagining#path'(A, C) :-
    'https://josd.github.io/imagining#oneway'(A, B),
    'https://josd.github.io/imagining#path'(B, C).
