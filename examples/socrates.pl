...
'http://www.w3.org/1999/02/22-rdf-syntax-ns#type'(X,'http://example.org/ns#Mortal') <=
    ...
    'https://knowledgeonwebscale.github.io/ns#add_lemma'('http://www.w3.org/1999/02/22-rdf-syntax-ns#type'(X,'http://example.org/ns#Man'),'http://www.w3.org/1999/02/22-rdf-syntax-ns#type'(X,'http://example.org/ns#Mortal')).
