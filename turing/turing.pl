...
'https://josd.github.io/eyeglass#compute'([], OutTape) :-
    start(_MACHINE, I),
    find(I, [], "#", [], OutTape).
'https://josd.github.io/eyeglass#compute'([Head|Tail], OutTape) :-
    start(_MACHINE, I),
...
% query
query('https://josd.github.io/eyeglass#compute'([1,0,1,0,0,1], _ANSWER)).
query('https://josd.github.io/eyeglass#compute'([1,0,1,1,1,1], _ANSWER)).
query('https://josd.github.io/eyeglass#compute'([1,1,1,1,1,1], _ANSWER)).
query('https://josd.github.io/eyeglass#compute'([], _ANSWER)).
