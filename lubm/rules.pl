...
:- dynamic('http://www.example.org/AssistantProfessor'/1).
:- dynamic('http://www.example.org/AssociateProfessor'/1).
:- dynamic('http://www.example.org/Course'/1).
:- dynamic('http://www.example.org/Department'/1).
:- dynamic('http://www.example.org/FullProfessor'/1).
:- dynamic('http://www.example.org/GraduateCourse'/1).
:- dynamic('http://www.example.org/GraduateStudent'/1).
:- dynamic('http://www.example.org/Lecturer'/1).
:- dynamic('http://www.example.org/Publication'/1).
:- dynamic('http://www.example.org/ResearchAssistant'/1).
:- dynamic('http://www.example.org/ResearchGroup'/1).
:- dynamic('http://www.example.org/TeachingAssistant'/1).
:- dynamic('http://www.example.org/UndergraduateStudent'/1).
:- dynamic('http://www.example.org/University'/1).
:- dynamic('http://www.example.org/Employee'/1).
:- dynamic('http://www.example.org/Professor'/1).
:- dynamic('http://www.example.org/Organization'/1).
:- dynamic('http://www.example.org/AdministrativeStaff'/1).
:- dynamic('http://www.example.org/Article'/1).
:- dynamic('http://www.example.org/Work'/1).
:- dynamic('http://www.example.org/College'/1).
:- dynamic('http://www.example.org/Program'/1).
:- dynamic('http://www.example.org/Dean'/1).
:- dynamic('http://www.example.org/Faculty'/1).
:- dynamic('http://www.example.org/Schedule'/1).
:- dynamic('http://www.example.org/Chair'/1).
:- dynamic('http://www.example.org/Director'/1).
:- dynamic('http://www.example.org/Student'/1).
:- dynamic('http://www.example.org/Book'/1).
:- dynamic('http://www.example.org/ClericalStaff'/1).
:- dynamic('http://www.example.org/ConferencePaper'/1).
:- dynamic('http://www.example.org/Institute'/1).
:- dynamic('http://www.example.org/JournalArticle'/1).
:- dynamic('http://www.example.org/Manual'/1).
:- dynamic('http://www.example.org/PostDoc'/1).
:- dynamic('http://www.example.org/Research'/1).
:- dynamic('http://www.example.org/Software'/1).
:- dynamic('http://www.example.org/Specification'/1).
:- dynamic('http://www.example.org/SystemsStaff'/1).
:- dynamic('http://www.example.org/TechnicalReport'/1).
:- dynamic('http://www.example.org/UnofficialPublication'/1).
:- dynamic('http://www.example.org/VisitingProfessor'/1).
