...
'<https://josd.github.io/imagining#primerange>'([A,B],L) :-
...
'<https://josd.github.io/imagining#totient>'(N,Phi) :-
...
% query
query('<https://josd.github.io/imagining#primerange>'([0,100],_ANSWER)).
query('<https://josd.github.io/imagining#primerange>'([1000000,1000100],_ANSWER)).
query('<https://josd.github.io/imagining#totient>'(271,_ANSWER)).
query('<https://josd.github.io/imagining#totient>'(2718281,_ANSWER)).
query('<https://josd.github.io/imagining#totient>'(27182818284,_ANSWER)).
query('<https://josd.github.io/imagining#totient>'(271828182845904,_ANSWER)).
