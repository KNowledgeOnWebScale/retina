...
'https://josd.github.io/eyeglass#primerange'([A,B],L) :-
...
'https://josd.github.io/eyeglass#totient'(N,Phi) :-
...
% query
query('https://josd.github.io/eyeglass#primerange'([0,100],_ANSWER)).
query('https://josd.github.io/eyeglass#primerange'([1000000,1000100],_ANSWER)).
query('https://josd.github.io/eyeglass#totient'(271,_ANSWER)).
query('https://josd.github.io/eyeglass#totient'(2718281,_ANSWER)).
query('https://josd.github.io/eyeglass#totient'(27182818284,_ANSWER)).
query('https://josd.github.io/eyeglass#totient'(271828182845904,_ANSWER)).
